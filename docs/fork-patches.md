...
| `4939c5b` | feat(watch): wake on Bridge inbox traffic (#2) | keep | Real upstream has no Bridge inbox concept; the merged watcher retains the fork's per-home vessel configuration, bounded fetch, priority cadence, and wake logic. | `ad9f3a7` |
