...
That public in-band marker is a compatibility convention, not sender authentication; the away predicate classifies it structurally by its `away-supervisor` kind rather than by content, per the [`/afk` skill](../.agents/skills/afk/SKILL.md).
